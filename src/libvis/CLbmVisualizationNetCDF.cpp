...
void CLbmVisualizationNetCDF<T>::defineData()
{
	...
	nc_var_par_access(fileId, densitiesVarId, NC_COLLECTIVE);
	nc_var_par_access(fileId, velocitiesVarId[0], NC_COLLECTIVE);
	nc_var_par_access(fileId, velocitiesVarId[1], NC_COLLECTIVE);
	nc_var_par_access(fileId, velocitiesVarId[2], NC_COLLECTIVE);
#endif
}
