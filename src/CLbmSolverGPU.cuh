...
private:
	 ...
	 * threadsPerBlock[0][0,1,2]: number of threads per block for kernel lbm_init()
	 * threadsPerBlock[1][0,1,2]: number of threads per block for kernel lbm_alpha()
	 * threadsPerBlock[2][0,1,2]: number of threads per block for kernel lbm_beta()
	 */
//	std::vector<std::vector<int> > threadsPerBlock(3, std::vector<int>(3));
