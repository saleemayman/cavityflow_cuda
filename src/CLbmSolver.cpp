...
template <class T>
CLbmSolver<T>::CLbmSolver(int UID, CCL::CCommandQueue &p_cCommandQueue,
...
template <class T>
std::vector<std::string> CLbmSolver<T>::split(const std::string& str,
...
template <class T>
void CLbmSolver<T>::enqueueCopyRectKernel(CCL::CMem& src, CCL::CMem& dst,
        ...
        CVector<3, int> block_size, bool withBarrier)
{
...
template <class T>
void CLbmSolver<T>::addDrivenCavityValue(T value)
{
...
template <class T>
void CLbmSolver<T>::simulationStepAlpha()
{
#if DEBUG
...
template <class T>
void CLbmSolver<T>::simulationStepBeta()
{
#if DEBUG
 ...
 */
template <class T>
void CLbmSolver<T>::simulationStep()
{
    /*
...
template <class T>
void CLbmSolver<T>::setGhostLayerBuffers(std::vector<CComm<T> *> &comm)
{
 ...
 */
template <class T>
void CLbmSolver<T>::storeDensityDistribution(T *dst)
{
...
template <class T>
void CLbmSolver<T>::storeDensityDistribution(T *dst, CVector<3,int> &origin,
...
template <class T>
void CLbmSolver<T>::setDensityDistribution(T *src, CVector<3,int> &origin,
        CVector<3, int> &size, int i)
{
 ...
 */
template <class T>
void CLbmSolver<T>::storeVelocity(T *dst)
{
 ...
 */
template <class T>
void CLbmSolver<T>::storeVelocity(T* dst, CVector<3, int> &origin, CVector<3, int> &size)
{
    CCL::CMem cBuffer;
 ...
 */
template <class T>
void CLbmSolver<T>::setVelocity(T* src, CVector<3, int> &origin, CVector<3, int> &size)
{
    CCL::CMem cBuffer;
 ...
 */
template <class T>
void CLbmSolver<T>::storeDensity(T *dst)
{
 ...
 */
template <class T>
void CLbmSolver<T>::storeDensity(T *dst, CVector<3, int> &origin, CVector<3,int> &size)
{
    CCL::CMem cBuffer;
 ...
 */
template <class T>
void CLbmSolver<T>::setDensity(T *src, CVector<3,int> &origin, CVector<3,int> &size)
{
    CCL::CMem cBuffer;
    cBuffer.createCopyToDevice(cContext,
...
template <class T>
void CLbmSolver<T>::storeFlags(int *dst)
{
    size_t byte_size = cMemDensity.getSize();
...
template <class T>
void CLbmSolver<T>::storeFlags(int *dst, CVector<3,int> &origin, CVector<3,int> &size)
{
    CCL::CMem cBuffer;
...
template <class T>
void CLbmSolver<T>::setFlags(int *src, CVector<3, int> &origin, CVector<3, int> &size)
{
    CCL::CMem cBuffer;
    cBuffer.createCopyToDevice(cContext,
...
template <class T>
bool CLbmSolver<T>::isDomainPowerOfTwo(size_t x)
{
...
template <class T>
void CLbmSolver<T>::debugChar(CCL::CMem &cMem, size_t wrap_size)
{
...
template <class T>
void CLbmSolver<T>::debugFloat(CCL::CMem &cMem, size_t wrap_size)
{
 ...
 */
template <class T>
void CLbmSolver<T>::debugDD(size_t dd_id, size_t wrap_size, size_t empty_line)
{
...
template <class T>
float CLbmSolver<T>::getVelocityChecksum()
{
