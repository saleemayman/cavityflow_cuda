...
python generate_configuration.py ${domainSizeX} ${domainSizeY} ${domainSizeZ} ${numOfSubdomainsX} ${numOfSubdomainsY} ${numOfSubdomainsZ} ${loops} ${doBenchmark} ${doLogging} ${doValidation} ${doVisualization} ${visualizationRate} ${numOfRanks} ${HOME} ${SCRATCH}
