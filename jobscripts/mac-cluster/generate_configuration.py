...
ET.SubElement(domainsize, "x").text = "1024"
ET.SubElement(domainsize, "y").text = "1024"
...
ET.SubElement(domianlength, "z").text = "0.03125"
...
ET.SubElement(simulation, "loops").text = "1901640"
